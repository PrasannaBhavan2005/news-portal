...
function AllNews({ theme }) {
  ...
  return (
    <div className={`min-h-screen pt-28 ${isDark ? "bg-black text-white" : "bg-white text-black"}`}>
      {error && (
      ...
      {!isLoading && data.length > 0 && (
        <div className="pagination flex justify-center gap-14 my-10 items-center">
          <button
            disabled={page <= 1}
            className={`pagination-btn text-center px-4 py-2 rounded-md ${
